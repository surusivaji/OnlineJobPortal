  ...
  <body>
	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-center" style="height:90vh">
			<div class="col-md-10">
				<%
					Jobs jobs = (Jobs) session.getAttribute("jobs");
				%>
				<div class="card">
					...
					<div class="card-body">
						<form action="/admin/updateJob" method="post">
							<input type="hidden" class="form-control" name="id" value="<%= jobs.getId() %>" id="id" autocomplete="off" required>
							<div class="form-group">
								<label for="title">Enter Title</label>
								<input type="text" class="form-control" name="title" value="<%= jobs.getTitle() %>" id="title" autocomplete="off" required>
							</div>
							<div class="row mt-3">
								<div class="col-md-4">
								...
								<div class="col-md-4">
									...
									<select name="category" id="category" class="form-control">
										...
										<option value="Software Developer">Sortware Developer</option>
										<option value="Tester">Tester</option>
										<option value="Devops Engineer">Devops Engineer</option>
										<option value="AWS">AWS Engineer</option>
							...
							<div class="form-group mt-3">
								...
								<textarea name="description" id="description" class="form-control" rows="7" cols="">
									${jobs.description}
								</textarea>
							</div>
