			...
			<div class="col-md-5">
				<div class="card shadow p-2">
					<div class="card-head pt-3 text-center">
						<i class="fa-solid fa-user-plus fa-2x fw-bold"></i><br>
						<h2>Registration</h2>
					</div>
					<div class="card-body">
						...
						%>
						<!-- alert message ends -->
						<form action="/saveUserInformation" method="post">
							...
							<div class="form-group mt-3">
								...
								<input type="text" name="qualification" id="qualification" class="form-control" autocomplete="off" required>
							</div>
							</div>
